...
CREATE UNIQUE INDEX IF NOT EXISTS unique_ref_tx_in ON public.reference_tx_in USING btree (tx_in_id, tx_out_id, tx_out_index);
...
CREATE INDEX IF NOT EXISTS idx_ma_tx_out_ident ON public.ma_tx_out (ident) INCLUDE (tx_out_id, quantity);
