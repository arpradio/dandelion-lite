/*
ISSUES:
	Takes too long on CARDANO_DB_SYNC_IMAGE="ghcr.io/intersectmbo/cardano-db-sync:13.1.1.3"
*/
...
-- CREATE UNIQUE INDEX IF NOT EXISTS unique_ma_tx_out ON public.ma_tx_out USING btree (ident, tx_out_id DESC); -- hanging/taking too long
...
-- CREATE INDEX IF NOT EXISTS idx_ma_tx_out_ident ON public.ma_tx_out (ident) INCLUDE (tx_out_id, quantity); -- hanging/taking too long
CREATE INDEX IF NOT EXISTS idx_collateral_tx_in_tx_in_id ON public.collateral_tx_in (tx_in_id);
CREATE INDEX IF NOT EXISTS idx_reference_tx_in_tx_in_id ON public.reference_tx_in (tx_in_id);
