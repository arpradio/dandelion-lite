...
# curl -skX POST https://127.0.0.1:3081/koios/api/v1/address_utxos -H accept:application/json -H content-type:application/json -d {"_addresses":["addr_test1vzpwq95z3xyum8vqndgdd9mdnmafh3djcxnc6jemlgdmswcve6tkw","addr_test1vpfwv0ezc5g8a4mkku8hhy3y3vp92t7s3ul8g778g5yegsgalc6gc"],"_extended":true}
# curl -skX POST https://preprod.koios.rest/api/v1/address_utxos -H accept:application/json -H content-type:application/json -d {"_addresses":["addr_test1vzpwq95z3xyum8vqndgdd9mdnmafh3djcxnc6jemlgdmswcve6tkw","addr_test1vpfwv0ezc5g8a4mkku8hhy3y3vp92t7s3ul8g778g5yegsgalc6gc"],"_extended":true}
